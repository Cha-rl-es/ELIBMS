        ...
        <div class="container">
          <div class="card">
            <div class="content-head">
              <h2 class="content-title">Create New Book Record</h2>
              <a class="btn-link btn-secondary icon-btn" href="inventory.php" title="Back to Inventory">
                <i class="fa-solid fa-arrow-left"></i>
              </a>
            </div>
            <p class="page-note">Complete all fields to add a new book to the collection.</p>
          </div>
          ...
          <div class="card" style="max-width: 720px">
            <form id="addBookForm">
              ...
              <button class="btn-primary icon-btn" type="submit" title="Save Book"><i class="fa-solid fa-floppy-disk"></i></button>
              <p id="addBookMessage" class="message"></p>
            </form>
          </div>
        </div>
      </main>
